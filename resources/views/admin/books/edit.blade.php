                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Form Edit Data Buku</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="{{ route('books.update', $books->id)}}" method="post" class="" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tahunterbit" class="form-control" value=" {{ $books->tahunterbit}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputdeskripsi" class=" form-control-label">Deskripsi</label>
                                                <textarea name="deskripsi" cols ="30" class="form-control" value=" {{ $books->deskripsi }}"></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="inputfile" class=" form-control-label">Cover</label>
                                                <input type="file" name="file_path" class="form-control" value=" {{ $books->file_path }}" required id="inputfile" >
                                            </div>
