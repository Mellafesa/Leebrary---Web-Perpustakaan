                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="{{asset('admin/images/icon/icon_leebrary_register.png')}}" alt="Leebrary">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <button class="au-btn au-btn--block au-btn--black m-b-20" type="submit">register</button>
